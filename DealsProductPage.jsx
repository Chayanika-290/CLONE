...
import { dealsProductPageData } from '../../data/productsDealsProductPage';
import 'swiper/css';
...
const DealsProductPage = () => {
  ...
  const productData = dealsProductPageData[id];

  useEffect(() => {
    console.log('Current ID:', id);
    console.log('Available IDs:', Object.keys(dealsProductPageData));
