...
import { salesViewProductPageData } from '../../data/productsSalesViewProductPage';

const SalesViewProductPage = () => {
  const [selectedColor, setSelectedColor] = useState(0);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const { id } = useParams();
  const navigate = useNavigate();
  const productData = salesViewProductPageData[id];
...
export default SalesViewProductPage;
