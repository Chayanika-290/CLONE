...
import { shopCategoriesNirvanaData } from '../../data/productsShopCategoriesNirvana';
import Footer from '../Footer/Footer';

const ShopCategoriesNirvana = () => {
  return (
    <>
      {/* Breadcrumb */}
      <div className="max-w-[1440px] mx-auto px-6 py-4">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-900">Nirvana by boAt</span>
        </div>
      </div>
      ...
      <div className="w-full h-[400px] relative">
        <img 
          src="/ShopCategories/ShopCategoriesNirvana/nirvana.webp" 
          alt="Nirvana by boAt" 
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-8">
        <h1 className="text-4xl font-bold text-black">Nirvana by boAt</h1>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {shopCategoriesNirvanaData.map((product) => (
...
export default ShopCategoriesNirvana;
