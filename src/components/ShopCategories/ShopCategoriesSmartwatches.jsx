...
import { shopCategoriesSmartWatchesData } from '../../data/productsShopCategoriesSmartwatches';
import Footer from '../Footer/Footer';

const ShopCategoriesSmartwatches = () => {
  return (
    <div className="max-w-[1440px] mx-auto px-6 py-8">
      ...
      <div className="flex items-center gap-2 text-sm mb-6">
        ...
        <span className="text-gray-900">Smartwatches</span>
      </div>

      <h1 className="text-2xl font-bold mb-8">Smartwatches</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
        {shopCategoriesSmartWatchesData.map((product) => (
...
export default ShopCategoriesSmartwatches;
