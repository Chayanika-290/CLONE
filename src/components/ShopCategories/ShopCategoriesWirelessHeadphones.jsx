...
import { shopCategoriesWirelessHeadphonesData } from '../../data/productsShopCategoriesWirelessHeadphones';
import Footer from '../Footer/Footer';

const ShopCategoriesWirelessHeadphones = () => {
  return (
    <>
      {/* Breadcrumb */}
      <div className="max-w-[1440px] mx-auto px-6 py-4">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-900">Rockerz Headphones</span>
        </div>
      </div>

      {/* Header */}
      <div className="max-w-[1440px] mx-auto px-6 py-8">
        <h1 className="text-4xl font-bold text-black">Rockerz Headphones</h1>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {shopCategoriesWirelessHeadphonesData.map((product) => (
...
export default ShopCategoriesWirelessHeadphones;
