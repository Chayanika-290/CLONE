...
import { shopCategoriesWirelessSpeakersData } from '../../data/productsShopCategoriesWirelessSpeakers';
import Footer from '../Footer/Footer';

const ShopCategoriesWirelessSpeakers = () => {
  return (
    <>
      {/* Breadcrumb */}
      <div className="max-w-[1440px] mx-auto px-6 py-4">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-900">Wireless Speakers</span>
        </div>
      </div>

      {/* Header */}
      <div className="max-w-[1440px] mx-auto px-6 py-8">
        <h1 className="text-4xl font-bold text-black">Wireless Speakers</h1>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {shopCategoriesWirelessSpeakersData.map((product) => (
            <div key={product.id} className="bg-white rounded-lg overflow-hidden border border-gray-200 flex flex-col">
              <div className="relative">
                ...
                <div className="absolute bottom-2 left-2 bg-yellow-400 text-black text-[10px] px-1.5 py-0.5 rounded-full">
                  {product.specialFeature || product.playbackTime}
                </div>
              </div>
...
export default ShopCategoriesWirelessSpeakers;
