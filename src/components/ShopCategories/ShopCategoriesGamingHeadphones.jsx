...
import { shopCategoriesGamingHeadphonesData } from '../../data/productsShopCategoriesGamingHeadphones';
import Footer from '../Footer/Footer';

const ShopCategoriesGamingHeadphones = () => {
  return (
    <>
      {/* Breadcrumb */}
      <div className="max-w-[1440px] mx-auto px-6 py-4">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-900">Immortal Gaming</span>
        </div>
      </div>
      ...
      <div className="w-full">
        <img 
          src="ShopCategories/ShopCategoriesGamingHeadphones/gaming.webp"
          alt="Immortal Gaming"
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-8">
        <h1 className="text-4xl font-bold text-black">Immortal Gaming</h1>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {shopCategoriesGamingHeadphonesData.map((product) => (
              ...
              <div className="p-3 flex flex-col flex-grow border-t border-gray-100">
                ...
                <div className="mt-auto">
                  {product.isRestocking ? (
                    <button className="w-full border border-black text-black text-xs py-1.5 rounded">
                      Notify Me
                    </button>
                  ) : (
...
export default ShopCategoriesGamingHeadphones;
