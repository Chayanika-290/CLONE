...
import { shopCategoriesWiredHeadphonesData } from '../../data/productsShopCategoriesWiredHeadphones';
import Footer from '../Footer/Footer';

const ShopCategoriesWiredHeadphones = () => {
  return (
    <>
      {/* Breadcrumb */}
      <div className="max-w-[1440px] mx-auto px-6 py-4">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-900">Wired Headphones</span>
        </div>
      </div>

      {/* Header */}
      <div className="max-w-[1440px] mx-auto px-6 py-8">
        <h1 className="text-4xl font-bold text-black">Wired Headphones</h1>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {shopCategoriesWiredHeadphonesData.map((product) => (
...
export default ShopCategoriesWiredHeadphones;
