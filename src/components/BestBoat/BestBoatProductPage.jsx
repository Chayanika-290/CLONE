...
import { bestBoatProductPageData } from '../../data/productsBestBoatProductPage';

const BestBoatProductPage = () => {
  const [selectedColor, setSelectedColor] = useState(0);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const { category, id } = useParams();
  const navigate = useNavigate();
  const productData = bestBoatProductPageData[category]?.[id];
...
export default BestBoatProductPage;
