...
import { smartwatchesProductPageData } from '../../data/productsSmartwatchesProductPage';
import 'swiper/css';
import 'swiper/css/navigation';
import 'swiper/css/thumbs';
import './SmartwatchesProduct.css';

const SmartwatchesProductPage = () => {
  const [selectedColor, setSelectedColor] = useState(0);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const { id } = useParams();
  const navigate = useNavigate();
  const productData = smartwatchesProductPageData[id];
...
export default SmartwatchesProductPage;
