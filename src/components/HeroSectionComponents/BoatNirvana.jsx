...
import { boatNirvanaData } from '../../data/productsBoatNirvana';
...
const BoatNirvana = () => {
  ...
  const product = boatNirvanaData.products[selectedProduct];
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 py-8">
      ...
      <div className="flex items-center gap-2 text-sm mb-8 text-gray-600">
        ...
        <span>/</span>
        <Link to="/headphones" className="hover:text-gray-900">Headphones</Link>
        <span>/</span>
