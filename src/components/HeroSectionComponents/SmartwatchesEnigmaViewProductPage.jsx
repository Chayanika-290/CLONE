...
import { smartwatchesEnigmaViewProductPageData } from '../../data/productsSmartwatchesEnigmaViewProductPage';
import 'swiper/css';
import 'swiper/css/navigation';
import 'swiper/css/thumbs';

const SmartwatchesEnigmaViewProductPage = () => {
  const [selectedColor, setSelectedColor] = useState(0);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const { id } = useParams();
  const navigate = useNavigate();
  const productData = smartwatchesEnigmaViewProductPageData[id];
...
export default SmartwatchesEnigmaViewProductPage;
