...
import { personalisedProductsData } from '../../data/productsPersonalisedProducts';
...
const PersonalisedProducts = () => {
  ...
  const product = personalisedProductsData.products[selectedProduct];
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 py-8">
      ...
      <div className="flex items-center gap-2 text-sm mb-8 text-gray-600">
        ...
        <span>/</span>
        <Link to="/wireless-headphones" className="hover:text-gray-900">Wireless Headphones</Link>
        <span>/</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          {/* Color Selection */}
          <div className="mb-8">
            <h3 className="text-lg mb-4">Choose your edition:</h3>
            <div className="flex gap-4">
