...
import { smartwatchesEnigmaProductPageData } from '../../data/productsSmartwatchesEnigmaProductPage';
import 'swiper/css';
import 'swiper/css/navigation';
import 'swiper/css/thumbs';
import './SmartwatchesProduct.css';

const SmartwatchesEnigmaProductPage = () => {
  const [selectedColor, setSelectedColor] = useState(0);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const { id } = useParams();
  const navigate = useNavigate();
  const productData = smartwatchesEnigmaProductPageData[id];
...
export default SmartwatchesEnigmaProductPage;
