...
import { stoneBujjiData } from '../../data/productsStoneBujji';

const StoneBujji = () => {
  const [selectedProduct, setSelectedProduct] = useState(0);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const product = stoneBujjiData.products[selectedProduct];
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 py-8">
      ...
      <div className="flex items-center gap-2 text-sm mb-8 text-gray-600">
        ...
        <span>/</span>
        <Link to="/neckbands" className="hover:text-gray-900">Neckbands</Link>
        <span>/</span>
