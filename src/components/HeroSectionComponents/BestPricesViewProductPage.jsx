...
import { bestPricesViewPageData } from '../../data/productsBestPricesViewProductPage';
import 'swiper/css';
import 'swiper/css/navigation';
import 'swiper/css/thumbs';
import './BestPricesProduct.css';

const BestPricesViewProductPage = () => {
  const [selectedColor, setSelectedColor] = useState(0);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const { id } = useParams();
  const navigate = useNavigate();
  const productData = bestPricesViewPageData[id];
...
export default BestPricesViewProductPage;
